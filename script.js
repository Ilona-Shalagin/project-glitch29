...
function choice(){
    image.setAttribute("src","image/_image2portrait.jpeg");
...
function study(){
    image.setAttribute("src","image/_image3portrait.jpeg");
...
function degree(){
    image.setAttribute("src","image/_image5portrait.jpeg");
...
function studyTwo(){
    image.setAttribute("src","image/_image8portrait.jpeg");
    text.textContent = "will she get a job?";
    buttonOne.textContent = "Yes";
    buttonTwo.textContent = "No";
...
function work(){
    image.setAttribute("src","image/_image7portrait.jpeg");
...
function degreeTwo(){
    image.setAttribute("src","image/_image9portrait.jpeg");
...
function workTwo(){
    image.setAttribute("src","image/_image10portrait.jpeg");
...
function choiceTwo() {
    image.setAttribute("src","image/_image6portrait.jpeg");
    text.textContent = "What major will she choose?";
...
function major(){
    image.setAttribute("src","image/_image11portrait.jpeg");
...
function job(){
    image.setAttribute("src","image/_image12portrait.jpeg");
...
function majorTwo(){
    image.setAttribute("src","image/_image13portrait.jpeg");
...
function career(){
    image.setAttribute("src","image/_image14portrait.jpeg");
...
function jobTwo(){
    image.setAttribute("src","image/_image15portrait.jpeg");
